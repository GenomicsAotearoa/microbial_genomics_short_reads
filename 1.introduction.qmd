...
This workshop works through sequencing data from 10 isolates of *Microcoleus*. Species from this benthic cyanobacteria are ubiquitous and form thick mats in freshwater systems, such as rivers, that are sometimes toxic due to the production of potent neurotoxins (anatoxins).
