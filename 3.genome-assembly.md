...
#!/bin/bash -e
#SBATCH -A uoa00626
#SBATCH -J spades_assembly_v1
#SBATCH --time 00:45:00
#SBATCH --mem 10GB
#SBATCH --array=0-9
#SBATCH --ntasks 1
#SBATCH --cpus-per-task 8
#SBATCH -e slurm_spades_assembly_v1_%A-%a.err
#SBATCH -o slurm_spades_assembly_v1_%A-%a.out
...
#!/bin/bash -e
#SBATCH -A uoa00626
#SBATCH -J spades_assembly_v2
#SBATCH --time 00:45:00
#SBATCH --mem 10GB
#SBATCH --array=0-9
#SBATCH --ntasks 1
#SBATCH --cpus-per-task 8
#SBATCH -e slurm_spades_assembly_v2_%A-%a.err
#SBATCH -o slurm_spades_assembly_v2_%A-%a.out
...
#!/bin/bash -e
#SBATCH -A uoa00626
#SBATCH -J spades_assembly_v3
#SBATCH --time 00:45:00
#SBATCH --mem 10GB
#SBATCH --array=0-9
#SBATCH --ntasks 1
#SBATCH --cpus-per-task 8
#SBATCH -e slurm_spades_assembly_v3_%A-%a.err
#SBATCH -o slurm_spades_assembly_v3_%A-%a.out
